...
export default function Banner() {
  ...
  return (
    <>
      <div className="banner relative w-full m-auto">
        <img src={banner} alt="not found" className="w-full h-full" ref={ref} />
        <div className="banner__title absolute top-48 text-white lg:text-[78px] font-bold ml-[100px]">
          Sàn giao dịch bất động sản
        </div>
        <div className="banner__groupip absolute bottom-24 lg:bottom-32 w-full lg:w-[1040px] lg:h-48 rounded-2xl bg-[#7e365c] bg-opacity-70 lg:ml-[100px] flex items-center">
          <div className="banner__ipone p-0 m-0 lg:max-w-[300px] lg:w-[280px] ml-10">
            <h1 className="text-xl md:text-[24px] mb-2 text-white">Tỉnh</h1>
            <div
            ...
            <div
              className={`select-box shadow-xl absolute lg:max-w-[300px] lg:w-[280px] bg-white mt-2 rounded-md ${
                active ? 'active' : 'close'
              }`}>
          ...
          <div className="banner__ipone p-0 m-0 lg:max-w-[300px] lg:w-[280px] ml-10">
            <h1 className="text-xl md:text-[24px] mb-2 text-white">Chọn diện tích</h1>
            <div
            ...
            <div
              className={`select-box-two absolute lg:max-w-[300px] shadow-xl lg:w-[280px] bg-white mt-2 rounded-md ${
          ...
          <div className="hidden lg:flex flex-1 justify-end mr-12 text-white">
            <form
              action=""
