...
export default function wishlist() {
  ...
  // console.log(Json.Datas.products);
  ...
  // eslint-disable-next-line react-hooks/rules-of-hooks
  useEffect(() => {
    // JsonData.Datas.products.forEach((res) => {
    ProductType.forEach((products, x) => {
      // console.log("---000----");
      JsonData.Datas.products.forEach((product, i) => {
  ...
  return (
    <div className="products-container mb-32">
      ...
      <h1 className="my-8 lg:my-20 lg:text-[38px] mx-8 lg:mx-32 flex font-semibold">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-5 gap-y-10 mx-8 lg:mx-32">
