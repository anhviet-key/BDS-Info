...
export default function Open() {
  ...
  useEffect(() => {
    JsonData.Datas.project.forEach((res) => {
      setProject((pre) => [...pre, res]);
      console.log(res);
    });
  }, []);
  ...
  return (
    <>
      <div className="maxw">
        <div className="md:text-5xl text-center text-slate-600 font-semibold">
          Dự án sắp mở bán
          <div className="w-max m-auto">
            <div className="w-40 rounded-md h-2 bg-green-500"></div>
          </div>
        </div>
        <div className="mt-8 md:mt-20 flex px-10 lg:px-0">
