...
export default function Contact() {
  ...
  return (
    <div className="m-8 lg:mx-32">
      <div className="lg:text-5xl text-center text-slate-600 font-semibold">
        Liên hệ
        <div className="w-max m-auto">
          <div className="w-40 rounded-md h-2 bg-green-500"></div>
        </div>
      </div>
      <div className="col flex mt-8 lg:mt-20 gap-8 flex-col lg:flex-row lg:gap-0">
        <div className="cl1 flex-[2]">
          <h1 className="font-godman md:text-2xl pl-5 mb-10">Liên hệ</h1>
        ...
        <div className="cl2 flex-[1]">
          <h1 className="font-godman md:text-2xl pl-5 mb-10">
            Thông tin liên hệ
          </h1>
        ...
        <div className="cl2 flex-[1]">
          <h1 className="font-godman md:text-2xl pl-5 mb-10">Về chúng tôi</h1>
